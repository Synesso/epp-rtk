...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epp02/rtk/xml/EPPXMLBase.java,v 1.4 2003/12/23 18:23:32 tubadanm Exp $
 * $Revision: 1.4 $
 * $Date: 2003/12/23 18:23:32 $
 */
...
public abstract class EPPXMLBase extends RTKBase
{
    ...
    protected epp_Response parseGenericResult(Node response_node) throws epp_XMLException
    {
        ...
        else
        {
            ...
            // The raw String value should be returned
