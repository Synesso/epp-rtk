...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epp02/rtk/xml/EPPHostUpdate.java,v 1.1 2003/03/21 17:13:42 tubadanm Exp $
 * $Revision: 1.1 $
 ...
 * @see org.openrtk.idl.epp02.host.epp_HostUpdate
 * @see org.openrtk.idl.epp02.host.epp_HostUpdateReq
 * @see org.openrtk.idl.epp02.host.epp_HostUpdateRsp
...
public class EPPHostUpdate extends EPPHostBase implements epp_HostUpdate
{
     ...
     * @param value org.openrtk.idl.epp02.epp_HostUpdateReq
     */
     ...
     * @return value org.openrtk.idl.epp02.epp_HostUpdateRsp
     */
        ...
        if ( add_remove_items != null )
        {
                 ...
                 add_remove_items.m_addresses.length > 0 )
            {
                ...
                for (Iterator it = status_list.iterator(); it.hasNext();)
                {
                    ...
                    if ( address.m_type.value() >= host_ip_to_string_array_.length )
                    {
                        throw new epp_XMLException("invalid addresss type in request data");
                    }
                    addr_element.setAttribute("ip", host_ip_to_string_array_[address.m_type.value()]);
                }
            }
