...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epp02/rtk/xml/EPPDomainCreate.java,v 1.1 2003/03/21 17:13:41 tubadanm Exp $
 * $Revision: 1.1 $
 ...
 * @see org.openrtk.idl.epp02.domain.epp_DomainCreate
 * @see org.openrtk.idl.epp02.domain.epp_DomainCreateReq
 * @see org.openrtk.idl.epp02.domain.epp_DomainCreateRsp
...
public class EPPDomainCreate extends EPPDomainBase implements epp_DomainCreate
{
     ...
     * @param value org.openrtk.idl.epp02.epp_DomainCreateReq
     */
     ...
     * @return value org.openrtk.idl.epp02.epp_DomainCreateRsp
     */
    ...
    public String toXML() throws epp_XMLException
    {
             ...
             action_request_.m_contacts.length > 0 )
        {
            ...
            for (Iterator it = contacts.iterator(); it.hasNext();)
            {
                ...
                Element contact_element = addXMLElement(doc, domain_create, "domain:contact", domain_contact.m_roid);
        ...
        domain_create.appendChild( prepareAuthInfo( doc, "domain:authInfo", action_request_.m_auth_info ) );
