...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epp02/rtk/xml/EPPContactCheck.java,v 1.1 2003/03/21 17:13:40 tubadanm Exp $
 * $Revision: 1.1 $
 ...
 * @see org.openrtk.idl.epp02.contact.epp_ContactCheck
 * @see org.openrtk.idl.epp02.contact.epp_ContactCheckReq
 * @see org.openrtk.idl.epp02.contact.epp_ContactCheckRsp
...
public class EPPContactCheck extends EPPContactBase implements epp_ContactCheck
{
     ...
     * @param value org.openrtk.idl.epp02.epp_ContactCheckReq
     */
     ...
     * @return value org.openrtk.idl.epp02.epp_ContactCheckRsp
     */
    ...
    public String toXML() throws epp_XMLException
    {
        ...
        if ( action_request_ == null || 
             ...
             action_request_.m_roids == null ||
             action_request_.m_roids.length == 0 )
        {
        ...
        List contact_roids = Arrays.asList(action_request_.m_roids);
        
        for (Iterator it = contact_roids.iterator(); it.hasNext();)
        {
            String contact_roid = (String)it.next();
            addXMLElement(doc, contact_check, "contact:roid", contact_roid);
        }
