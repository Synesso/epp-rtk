...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epp0503/rtk/EPPClient.java,v 1.1 2003/03/21 16:18:21 tubadanm Exp $
 * $Revision: 1.1 $
 * $Date: 2003/03/21 16:18:21 $
 */

package com.tucows.oxrs.epp0503.rtk;

import java.io.*;
import java.net.*;
import org.openrtk.idl.epp0503.*;
import com.tucows.oxrs.epp0503.rtk.xml.*;
import com.tucows.oxrs.epp0503.rtk.transport.*;
...
public class EPPClient extends RTKBase implements epp_Session
{
     ...
     */
    public static final String DEFAULT_TRANSPORT_PACKAGE = "com.tucows.oxrs.epp0503.rtk.transport";
     ...
     * @throws IOException
     * @see #getEPPTimeout()
     * @see com.tucows.oxrs.epp0503.rtk.transport.EPPTransportTCP
     */
     ...
     * @throws org.openrtk.idl.epp0503.epp_Exception if there was a socket error in reading from the EPP Server
     */
     ...
     * @throws org.openrtk.idl.epp0503.epp_Exception if a communication error occurs
     */
     ...
     * @throws org.openrtk.idl.epp0503.epp_XMLException if any request data or response data is missing
     * @throws org.openrtk.idl.epp0503.epp_Exception if a communication error occurs or if the server returns an error code
     ...
     * @throws org.openrtk.idl.epp0503.epp_Exception if the server greeting is not present
     * @throws org.openrtk.idl.epp0503.epp_XMLException if the server's greeting is not parsable
     * @throws com.tucows.oxrs.epp0503.rtk.transport.EPPTransportException if there are problems initializing the transport
     * @see #connect()
     * @see #getGreeting()
     */
     ...
     * @throws org.openrtk.idl.epp0503.epp_XMLException if the request XML could not be built or if the response XML could not be parsed.
     * @throws org.openrtk.idl.epp0503.epp_Exception if the EPP Server responded with an error code
     */
    ...
    public void login(String client_tr_id, String new_password) throws epp_XMLException, epp_Exception
    {
        ...
        if( sendver_ ) command_data.setExtension( new com.tucows.oxrs.epp0503.rtk.xml.extension.RTKVersion() );
