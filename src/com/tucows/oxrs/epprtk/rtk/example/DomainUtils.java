...
public class DomainUtils {
    ...
    public static Boolean checkDomain(EPPClient client, String domainName) throws epp_XMLException, epp_Exception, Exception 
    {
        ...
        Map domainsAvail = checkDomains(client, domainNames);
     ...
     * @throws Exception
     */
    public static epp_DomainCreateRsp createDomain(
            EPPClient client, 
            String domainName,
            int period,
            List nameServers,
            ...
            ) throws epp_XMLException, epp_Exception, Exception 
    {
        ...
        domain_create_request.setContacts((epp_DomainContact[])contacts.toArray(new epp_DomainContact[1]));
     ...
     * @throws Exception
     */
    public static epp_DomainInfoRsp infoDomain(
            EPPClient client,
            String domainName) throws epp_XMLException, epp_Exception, Exception {
     ...
     */
    public static epp_DomainRenewRsp renewDomain(
            EPPClient client,
            String domainName,
            int period,
            Date expiryDate) throws epp_XMLException, epp_Exception, Exception 
    {
     ...
     * @throws Exception
     */
    public static epp_DomainTransferRsp transferDomain(
            EPPClient client, 
            String domainName, 
            epp_TransferOpType operation,
            String authInfo) throws epp_XMLException, epp_Exception, Exception
    {
     ...
     * @throws Exception
     */
    public static epp_DomainUpdateRsp updateDomain(
            EPPClient client,
            String domainName,
            epp_DomainUpdateAddRemove add,
            epp_DomainUpdateAddRemove remove,
            epp_DomainUpdateChange change) throws epp_XMLException, epp_Exception, Exception 
    {
