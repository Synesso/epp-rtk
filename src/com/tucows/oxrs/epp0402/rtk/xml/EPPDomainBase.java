...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epp0402/rtk/xml/EPPDomainBase.java,v 1.1 2003/03/21 16:35:36 tubadanm Exp $
 * $Revision: 1.1 $
...
public abstract class EPPDomainBase extends EPPXMLBase
{
    ...
    {
        command.setAttribute("xmlns:domain", "urn:iana:xml:ns:domain-1.0");
        command.setAttribute("xsi:schemaLocation", "urn:iana:xml:ns:domain-1.0 domain-1.0.xsd");
    }
