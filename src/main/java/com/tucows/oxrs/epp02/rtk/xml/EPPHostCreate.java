...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epp02/rtk/xml/EPPHostCreate.java,v 1.1 2003/03/21 17:13:42 tubadanm Exp $
 * $Revision: 1.1 $
 ...
 * @see org.openrtk.idl.epp02.host.epp_HostCreate
 * @see org.openrtk.idl.epp02.host.epp_HostCreateReq
 * @see org.openrtk.idl.epp02.host.epp_HostCreateRsp
...
public class EPPHostCreate extends EPPHostBase implements epp_HostCreate
{
     ...
     * @param value org.openrtk.idl.epp02.epp_HostCreateReq
     */
     ...
     * @return value org.openrtk.idl.epp02.epp_HostCreateRsp
     */
    ...
    public String toXML() throws epp_XMLException
    {
             ...
             action_request_.m_addresses.length > 0 )
        {
            ...
            for (Iterator it = addresses.iterator(); it.hasNext();)
            {
                ...
                {
                    throw new epp_XMLException("invalid address type in request");
                }
