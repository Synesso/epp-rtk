...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epp02/rtk/xml/EPPContactUpdate.java,v 1.1 2003/03/21 17:13:41 tubadanm Exp $
 * $Revision: 1.1 $
 ...
 * @see org.openrtk.idl.epp02.contact.epp_ContactUpdate
 * @see org.openrtk.idl.epp02.contact.epp_ContactUpdateReq
 * @see org.openrtk.idl.epp02.contact.epp_ContactUpdateRsp
...
public class EPPContactUpdate extends EPPContactBase implements epp_ContactUpdate
{
     ...
     * @param value org.openrtk.idl.epp02.epp_ContactUpdateReq
     */
     ...
     * @return value org.openrtk.idl.epp02.epp_ContactUpdateRsp
     */
    ...
    public String toXML() throws epp_XMLException
    {
        ...
        addXMLElement(doc, contact_update, "contact:roid", action_request_.m_roid);
                        ...
                        throws epp_XMLException
    {
        ...
        if ( change != null )
        {
            ...
            Element ascii_address = addressToXML(doc, "contact:ascii", change.m_ascii_address);
            if ( ascii_address != null )
            {
                change_element.appendChild(ascii_address);
            }

            Element i15d_address = addressToXML(doc, "contact:i15d", change.m_i15d_address);
            ...
            {
                change_element.appendChild( prepareAuthInfo( doc, "contact:authInfo", change.m_auth_info ) );
            }
