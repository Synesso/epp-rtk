...
public class HostExample
{
    ...
    private static String USAGE = "Usage: com.tucows.oxrs.epprtk.rtk.example.HostExample epp_host_name epp_host_port epp_client_id epp_password epp_domain_name";
