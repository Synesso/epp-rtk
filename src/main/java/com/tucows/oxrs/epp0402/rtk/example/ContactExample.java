...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epp0402/rtk/example/ContactExample.java,v 1.1 2003/03/21 16:35:34 tubadanm Exp $
 * $Revision: 1.1 $
 ...
 * @see com.tucows.oxrs.epp0402.rtk.xml.EPPContactCreate
...
public class ContactExample
{
    ...
    private static String USAGE = "Usage: com.tucows.oxrs.epp0402.rtk.example.ContactExample epp_contact_name epp_contact_port epp_client_id epp_password";
    ...
    **/
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            default_contact_id = epp_client_id + (System.currentTimeMillis() / 1000);
