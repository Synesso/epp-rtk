...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epp0604/rtk/xml/EPPXMLBase.java,v 1.1 2003/03/21 15:53:23 tubadanm Exp $
 * $Revision: 1.1 $
 * $Date: 2003/03/21 15:53:23 $
 */
 ...
 * @version $Revision: 1.1 $ $Date: 2003/03/21 15:53:23 $
**/
public abstract class EPPXMLBase extends RTKBase
{
     ...
     * @throws org.openrtk.idl.epp0604.epp_XMLException if the node list does not contain the result text
     */
    protected epp_Response parseGenericResult(Node response_node) throws epp_XMLException
    {
            ...
            for (int count1 = 0; count1 < result_nodes.getLength(); count1++)
            {
                ...
                if ( value_nodes.getLength() > 0 )
                {
                    for (int count2 = 0; count2 < value_nodes.getLength(); count2++)
                    {
                        ...
                        epp_ResultValue value = new epp_ResultValue( null,
                ...
                {
                    // This just looks sooo ugly... is there a better way?
                    // FIXME
        ...
        else
        {
            ...
            try
            {
                ...
                // Now have to isolate the extension XML without
                // the <extension> wrapping tags.
     ...
     * @throws org.openrtk.idl.epp0604.epp_XMLException if the node list does not contain the data
     */
