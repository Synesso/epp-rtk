...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epp0705/rtk/example/ContactExample.java,v 1.2 2003/04/09 18:32:32 tubadanm Exp $
 * $Revision: 1.2 $
 ...
 * @see com.tucows.oxrs.epp0705.rtk.xml.EPPContactCheck
 ...
 * @see com.tucows.oxrs.epp0705.rtk.xml.EPPContactDelete
**/
    ...
    public static void main(String args[])
    {
	    ...
	    // If epp_client.setEPPServices() or epp_client.setEPPUnspecServices() 
            ...
            try
            {
                ...
                // Type of INT is international which means only
                // the 7-bit subset of UTF-8 is permitted in the characters.
                // Type LOC (localized) permits full UTF-8.
                ...
                // Now assign that name/address set to the contact's addresses array.
		...
		// epp_ContactUpdateAddRemove add = new epp_ContactUpdateAddRemove();
                // add.setStatus(new epp_ContactStatus[1]);
                // add.getStatus()[0] = new epp_ContactStatus();
                // add.getStatus()[0].setType(epp_ContactStatusType.CLIENT_DELETE_PROHIBITED);
		// contact_update_request.setAdd(add);
		
                epp_ContactUpdateChange contact_update_change = new epp_ContactUpdateChange();
                
                epp_ContactNameAddress[] name_address = new epp_ContactNameAddress[1];
                name_address[0] = new epp_ContactNameAddress();
                // In a contact change request, you can update either or both of
                // the addresses current listed for the domain (localized and 
                // internationalized).  If an optional value is to be removed, then 
                // specify an empty string for the new value.
                // XXX enough info?
                name_address[0].setType(epp_ContactPostalInfoType.INT);
