...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epp0503/rtk/RTKBase.java,v 1.5 2003/12/24 17:42:04 tubadanm Exp $
 * $Revision: 1.5 $
...
public abstract class RTKBase extends org.omg.CORBA.portable.ObjectImpl
{
     ...
     * RTK Version number.
     */
    public static final String RTK_VERSION = "0.7.5-0503";
    ...
    public static void setDebugLevel()
    {
        ...
        try
        {
            String rtk_debuglevel_str = (String) RTKBase.getRTKProperties().getProperty("rtk.debug.level");
