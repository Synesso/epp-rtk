...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epp0503/rtk/xml/EPPLogout.java,v 1.1 2003/03/21 16:18:22 tubadanm Exp $
 * $Revision: 1.1 $
...
public class EPPLogout extends EPPXMLBase implements epp_Logout
{
    ...
    public String toXML() throws epp_XMLException
    {
        ...
        {
            prepareExtensionElement( doc, command, action_request_.m_extension );
        }
