...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epp0503/rtk/example/HostExample.java,v 1.1 2003/03/21 16:18:21 tubadanm Exp $
 * $Revision: 1.1 $
...
public class HostExample
{
    ...
    private static String USAGE = "Usage: com.tucows.oxrs.epp0503.rtk.example.HostExample epp_host_name epp_host_port epp_client_id epp_password epp_domain_name";
