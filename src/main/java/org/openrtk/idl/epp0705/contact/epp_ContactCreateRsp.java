 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0705/contact/epp_ContactCreateRsp.java,v 1.2 2003/09/10 21:29:59 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
...
public class epp_ContactCreateRsp implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_ContactCreateRsp (org.openrtk.idl.epp0705.epp_Response _m_rsp, String _m_id, String _m_creation_date)
  {
    m_rsp = _m_rsp;
    m_id = _m_id;
