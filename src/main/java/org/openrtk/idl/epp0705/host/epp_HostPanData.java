 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0705/host/epp_HostPanData.java,v 1.1 2003/03/20 22:42:31 tubadanm Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2003/03/20 22:42:31 $<br>
 */
public class epp_HostPanData extends org.openrtk.idl.epp0705.epp_PanData implements org.openrtk.idl.epp0705.epp_PollResData 
{

  /**
   * Constant variable defined by IDLs.</p>
   * Used when this classes is used to hold the poll response
   * data pertaining to host pending action notifications.  The value
   ...
   */
  public epp_HostPanData (String _m_name, boolean _m_result, org.openrtk.idl.epp0705.epp_TransID _m_trid, String _m_date)
  {
