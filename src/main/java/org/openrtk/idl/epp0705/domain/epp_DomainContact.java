 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0705/domain/epp_DomainContact.java,v 1.1 2003/03/20 22:42:29 tubadanm Exp $<br>
 * $Revision: 1.1 $<br>
...
public class epp_DomainContact implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setType(org.openrtk.idl.epp0705.domain.epp_DomainContactType)
   * @see #getType()
   */
  public org.openrtk.idl.epp0705.domain.epp_DomainContactType m_type = null;
  /**
   ...
   */
  public epp_DomainContact (org.openrtk.idl.epp0705.domain.epp_DomainContactType _m_type, String _m_id)
  {
    m_type = _m_type;
    m_id = _m_id;
  } // ctor
   ...
   * @see #m_type
   */
  public void setType(org.openrtk.idl.epp0705.domain.epp_DomainContactType value) { m_type = value; }
  /**
   * Accessor method for the type of the domain contact
   * @return The domain contact type
   * @see #m_type
   */
  public org.openrtk.idl.epp0705.domain.epp_DomainContactType getType() { return m_type; }
