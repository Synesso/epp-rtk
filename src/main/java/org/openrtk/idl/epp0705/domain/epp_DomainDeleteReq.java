 ...
 * in the registry.</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0705/domain/epp_DomainDeleteReq.java,v 1.2 2003/09/10 21:29:59 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
...
public class epp_DomainDeleteReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_DomainDeleteReq (org.openrtk.idl.epp0705.epp_Command _m_cmd, String _m_name)
  {
    m_cmd = _m_cmd;
    m_name = _m_name;
  } // ctor
