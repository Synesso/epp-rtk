...
/**
 * Class that contains the elements used to represent the domain update
 * response from the EPP server.</p>
 * Note usually instantiated by the RTK user, but rather by EPPDomainUpdate
 * and retrieved using that class' getResponseData() method.</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0705/domain/epp_DomainUpdateRsp.java,v 1.2 2003/09/10 21:29:59 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
 * $Date: 2003/09/10 21:29:59 $<br>
 * @see com.tucows.oxrs.epp0705.rtk.xml.EPPDomainUpdate
 * @see org.openrtk.idl.epp0705.domain.epp_DomainUpdateReq
 */
public class epp_DomainUpdateRsp implements org.omg.CORBA.portable.IDLEntity
{
  /**
   ...
   */
  public epp_DomainUpdateRsp (org.openrtk.idl.epp0705.epp_Response _m_rsp)
  {
    m_rsp = _m_rsp;
  } // ctor
