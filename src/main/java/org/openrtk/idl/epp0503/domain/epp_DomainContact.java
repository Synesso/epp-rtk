...
public class epp_DomainContact implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #m_type
   */
  public void setType(org.openrtk.idl.epp0503.domain.epp_DomainContactType value) { m_type = value; }
  /**
   * Accessor method for the type of the domain contact
   * @return The domain contact type
   * @see #m_type
   */
  public org.openrtk.idl.epp0503.domain.epp_DomainContactType getType() { return m_type; }
