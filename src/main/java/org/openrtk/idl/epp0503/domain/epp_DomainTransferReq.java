 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0503/domain/epp_DomainTransferReq.java,v 1.2 2003/09/10 21:29:57 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
...
public class epp_DomainTransferReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_DomainTransferReq (org.openrtk.idl.epp0503.epp_Command _m_cmd, org.openrtk.idl.epp0503.epp_TransferRequest _m_trans, String _m_name, org.openrtk.idl.epp0503.domain.epp_DomainPeriod _m_period)
  {
    m_cmd = _m_cmd;
    m_trans = _m_trans;
    m_name = _m_name;
   ...
   * @see #m_trans
   */
  public void setTrans(org.openrtk.idl.epp0503.epp_TransferRequest value) { m_trans = value; }
  /**
   * Accessor method for the common and gereric transfer request element
   * @return The domain transfer request object
   * @see #m_trans
   */
  public org.openrtk.idl.epp0503.epp_TransferRequest getTrans() { return m_trans; }
