 ...
 * in the registry.</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0503/domain/epp_DomainUpdateReq.java,v 1.2 2003/09/10 21:29:57 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
 * $Date: 2003/09/10 21:29:57 $<br>
 * @see com.tucows.oxrs.epp0503.rtk.xml.EPPDomainUpdate
 * @see org.openrtk.idl.epp0503.domain.epp_DomainUpdateRsp
 */
public class epp_DomainUpdateReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setAdd(org.openrtk.idl.epp0503.domain.epp_DomainUpdateAddRemove)
   * @see #getAdd()
   */
  public org.openrtk.idl.epp0503.domain.epp_DomainUpdateAddRemove m_add = null;
  /**
   * The change element that contains attribute values to be changed in the domain object.
   * @see #setChange(org.openrtk.idl.epp0503.domain.epp_DomainUpdateChange)
   * @see #getChange()
   */
  public org.openrtk.idl.epp0503.domain.epp_DomainUpdateChange m_change = null;
  /**
   * The remove element that contains attribute values to be removed from the domain object.
   * @see #setRemove(org.openrtk.idl.epp0503.domain.epp_DomainUpdateAddRemove)
   * @see #getRemove()
   */
  public org.openrtk.idl.epp0503.domain.epp_DomainUpdateAddRemove m_remove = null;
   ...
   */
  public epp_DomainUpdateReq (org.openrtk.idl.epp0503.epp_Command _m_cmd, String _m_name, org.openrtk.idl.epp0503.domain.epp_DomainUpdateAddRemove _m_add, org.openrtk.idl.epp0503.domain.epp_DomainUpdateChange _m_change, org.openrtk.idl.epp0503.domain.epp_DomainUpdateAddRemove _m_remove)
  {
    m_cmd = _m_cmd;
    m_name = _m_name;
    m_add = _m_add;
   ...
   * @see #m_add
   */
  public void setAdd(org.openrtk.idl.epp0503.domain.epp_DomainUpdateAddRemove value) { m_add = value; }
  /**
   * Accessor method for the add element that contains attribute values to be added to the domain object
   * @return The add element
   * @see #m_add
   */
  public org.openrtk.idl.epp0503.domain.epp_DomainUpdateAddRemove getAdd() { return m_add; }
   ...
   * @see #m_change
   */
  public void setChange(org.openrtk.idl.epp0503.domain.epp_DomainUpdateChange value) { m_change = value; }
  /**
   * Accessor method for the change element that contains attribute values to be changed
   * @return The change element
   * @see #m_change
   */
  public org.openrtk.idl.epp0503.domain.epp_DomainUpdateChange getChange() { return m_change; }
   ...
   * @see #m_remove
   */
  public void setRemove(org.openrtk.idl.epp0503.domain.epp_DomainUpdateAddRemove value) { m_remove = value; }
  /**
   * Accessor method for the remove element that contains attribute values to be removed from the domain object
   * @return The remove element
   * @see #m_remove
   */
  public org.openrtk.idl.epp0503.domain.epp_DomainUpdateAddRemove getRemove() { return m_remove; }
