...
/**
 * FIXME!</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0503/domain/epp_DomainTrnData.java,v 1.1 2003/03/21 16:18:30 tubadanm Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2003/03/21 16:18:30 $<br>
 * @see org.openrtk.idl.epp0503.domain.epp_DomainInfoReq
 */

public class epp_DomainTrnData extends org.omg.CORBA.portable.ObjectImpl implements org.omg.CORBA.portable.IDLEntity, org.openrtk.idl.epp0503.epp_PollResData 
{
   ...
   * @see #setTransferStatus(org.openrtk.idl.epp0503.epp_TransferStatusType)
   * @see #getTransferStatus()
   */
  public org.openrtk.idl.epp0503.epp_TransferStatusType m_transfer_status = null;
  /**
   ...
   */
  public epp_DomainTrnData (String _m_name, org.openrtk.idl.epp0503.epp_TransferStatusType _m_transfer_status, String _m_request_client_id, String _m_action_client_id, String _m_request_date, String _m_action_date, String _m_expiration_date)
  {
    m_name = _m_name;
   ...
   */
  public void setTransferStatus(org.openrtk.idl.epp0503.epp_TransferStatusType value) { m_transfer_status = value; }
  /**
   * Accessor method for the transfer status associated with the domain object
   * @return The domain transfer status
   * @see #m_transfer_status
   */
  public org.openrtk.idl.epp0503.epp_TransferStatusType getTransferStatus() { return m_transfer_status; }
