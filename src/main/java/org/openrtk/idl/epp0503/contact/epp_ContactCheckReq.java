 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0503/contact/epp_ContactCheckReq.java,v 1.2 2003/09/10 21:29:56 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
...
public class epp_ContactCheckReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_ContactCheckReq (org.openrtk.idl.epp0503.epp_Command _m_cmd, String[] _m_ids)
  {
    m_cmd = _m_cmd;
    m_ids = _m_ids;
  } // ctor
