 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0503/contact/epp_ContactInfoRsp.java,v 1.2 2003/09/10 21:29:56 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
...
public class epp_ContactInfoRsp implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setAsciiAddress(org.openrtk.idl.epp0503.contact.epp_ContactNameAddress)
   * @see #getAsciiAddress()
   */
  public org.openrtk.idl.epp0503.contact.epp_ContactNameAddress m_ascii_address = null;
  /**
   * The contact name and address associated with the contact object.
   * Content of this element may be represented in unrestricted UTF-8.
   * @see #setI15dAddress(org.openrtk.idl.epp0503.contact.epp_ContactNameAddress)
   * @see #getI15dAddress()
   */
  public org.openrtk.idl.epp0503.contact.epp_ContactNameAddress m_i15d_address = null;
  /**
   * The contact's telephone number.
   * @see #setVoice(org.openrtk.idl.epp0503.contact.epp_ContactPhone)
   * @see #getVoice()
   */
  public org.openrtk.idl.epp0503.contact.epp_ContactPhone m_voice = null;
  /**
   * The contact's fax number.
   * @see #setFax(org.openrtk.idl.epp0503.contact.epp_ContactPhone)
   * @see #getFax()
   */
  public org.openrtk.idl.epp0503.contact.epp_ContactPhone m_fax = null;
  /**
   ...
   * @see #setStatus(org.openrtk.idl.epp0503.contact.epp_ContactStatus[])
   * @see #getStatus()
   */
  public org.openrtk.idl.epp0503.contact.epp_ContactStatus m_status[] = null;
  /**
   ...
   */
  public epp_ContactInfoRsp (org.openrtk.idl.epp0503.epp_Response _m_rsp, String _m_id, String _m_roid, org.openrtk.idl.epp0503.contact.epp_ContactNameAddress _m_ascii_address, org.openrtk.idl.epp0503.contact.epp_ContactNameAddress _m_i15d_address, org.openrtk.idl.epp0503.contact.epp_ContactPhone _m_voice, org.openrtk.idl.epp0503.contact.epp_ContactPhone _m_fax, String _m_email, org.openrtk.idl.epp0503.contact.epp_ContactStatus[] _m_status, String _m_client_id, String _m_created_by, String _m_created_date, String _m_updated_by, String _m_updated_date, String _m_transfer_date, org.openrtk.idl.epp0503.epp_AuthInfo _m_auth_info)
  {
    m_rsp = _m_rsp;
    m_id = _m_id;
    m_roid = _m_roid;
   ...
   * @see #m_ascii_address
   */
  public void setAsciiAddress(org.openrtk.idl.epp0503.contact.epp_ContactNameAddress value) { m_ascii_address = value; }
  /**
   * Accessor method for the ascii contact name and address associated with the contact object
   * @return The contact ascii name and address
   * @see #m_ascii_address
   */
  public org.openrtk.idl.epp0503.contact.epp_ContactNameAddress getAsciiAddress() { return m_ascii_address; }
   ...
   * @see #m_i15d_address
   */
  public void setI15dAddress(org.openrtk.idl.epp0503.contact.epp_ContactNameAddress value) { m_i15d_address = value; }
  /**
   * Accessor method for the i15d contact name and address associated with the contact object
   * @return The contact i15d name and address
   * @see #m_i15d_address
   */
  public org.openrtk.idl.epp0503.contact.epp_ContactNameAddress getI15dAddress() { return m_i15d_address; }
   ...
   * @see #m_voice
   */
  public void setVoice(org.openrtk.idl.epp0503.contact.epp_ContactPhone value) { m_voice = value; }
  /**
   * Accessor method for the contact's telephone number
   * @return The contact's telephone number
   * @see #m_voice
   */
  public org.openrtk.idl.epp0503.contact.epp_ContactPhone getVoice() { return m_voice; }
   ...
   * @see #m_fax
   */
  public void setFax(org.openrtk.idl.epp0503.contact.epp_ContactPhone value) { m_fax = value; }
  /**
   * Accessor method for the contact's fax number
   * @param value The contact's fax number
   * @see #m_fax
  ...
  public void setFax(String value) { m_fax = new org.openrtk.idl.epp0503.contact.epp_ContactPhone("",value); }
  /**
   * Accessor method for the contact's fax number
   * @return The contact's fax number
   * @see #m_fax
   */
  public org.openrtk.idl.epp0503.contact.epp_ContactPhone getFax() { return m_fax; }
   ...
   * @see #m_status
   */
  public void setStatus(org.openrtk.idl.epp0503.contact.epp_ContactStatus[] value) { m_status = value; }
  /**
   * Accessor method for the array of status associated with the contact object
   * @return The array of contact status
   * @see #m_status
   */
  public org.openrtk.idl.epp0503.contact.epp_ContactStatus[] getStatus() { return m_status; }
