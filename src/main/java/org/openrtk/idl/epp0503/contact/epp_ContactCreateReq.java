 ...
 * in the registry.</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0503/contact/epp_ContactCreateReq.java,v 1.2 2003/09/10 21:29:56 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
 * $Date: 2003/09/10 21:29:56 $<br>
 * @see com.tucows.oxrs.epp0503.rtk.xml.EPPContactCreate
 * @see org.openrtk.idl.epp0503.contact.epp_ContactCreateRsp
 */
public class epp_ContactCreateReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_ContactCreateReq (org.openrtk.idl.epp0503.epp_Command _m_cmd, String _m_id, org.openrtk.idl.epp0503.contact.epp_ContactNameAddress _m_ascii_address, org.openrtk.idl.epp0503.contact.epp_ContactNameAddress _m_i15d_address, org.openrtk.idl.epp0503.contact.epp_ContactPhone _m_voice, org.openrtk.idl.epp0503.contact.epp_ContactPhone _m_fax, String _m_email, org.openrtk.idl.epp0503.epp_AuthInfo _m_auth_info)
  {
    m_cmd = _m_cmd;
    m_id = _m_id;
   ...
   */
  public String toString() { return this.getClass().getName() + ": { m_cmd ["+m_cmd+"] m_id ["+m_id+"] m_ascii_address ["+m_ascii_address+"] m_i15d_address ["+m_i15d_address+"] m_voice ["+m_voice+"] m_fax ["+m_fax+"] m_email ["+m_email+"] m_auth_info ["+m_auth_info+"] }"; }
