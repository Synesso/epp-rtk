 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/host/epp_HostUpdateAddRemove.java,v 1.1 2004/12/07 15:27:50 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2004/12/07 15:27:50 $<br>
 * @see org.openrtk.idl.epprtk.host.epp_HostUpdateReq#setAdd(epp_HostUpdateAddRemove)
 * @see org.openrtk.idl.epprtk.host.epp_HostUpdateReq#setRemove(epp_HostUpdateAddRemove)
 */
public class epp_HostUpdateAddRemove implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setStatus(org.openrtk.idl.epprtk.host.epp_HostStatus[])
   * @see #getStatus()
   */
  public org.openrtk.idl.epprtk.host.epp_HostStatus m_status[] = null;
   ...
   */
  public epp_HostUpdateAddRemove (org.openrtk.idl.epprtk.host.epp_HostAddress[] _m_addresses, org.openrtk.idl.epprtk.host.epp_HostStatus[] _m_status)
  {
   ...
   * @see #m_status
   */
  public void setStatus(org.openrtk.idl.epprtk.host.epp_HostStatus[] value) { m_status = value; }
  /**
   * Accessor method for the array of host status values
   * @return The array of host status values
   * @see #m_status
   */
  public org.openrtk.idl.epprtk.host.epp_HostStatus[] getStatus() { return m_status; }
