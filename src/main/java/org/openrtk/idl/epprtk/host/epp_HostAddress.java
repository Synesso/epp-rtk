 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/host/epp_HostAddress.java,v 1.1 2004/12/07 15:27:50 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
...
public class epp_HostAddress implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setType(org.openrtk.idl.epprtk.host.epp_HostAddressType)
   * @see #getType()
   */
  public org.openrtk.idl.epprtk.host.epp_HostAddressType m_type = null;
  /**
   ...
   */
  public epp_HostAddress (org.openrtk.idl.epprtk.host.epp_HostAddressType _m_type, String _m_ip)
  {
    m_type = _m_type;
    m_ip = _m_ip;
  } // ctor
   ...
   * @see #m_type
   */
  public void setType(org.openrtk.idl.epprtk.host.epp_HostAddressType value) { m_type = value; }
  /**
   * Accessor method for the type of the host address
   * @return The host address type
   * @see #m_type
   */
  public org.openrtk.idl.epprtk.host.epp_HostAddressType getType() { return m_type; }
