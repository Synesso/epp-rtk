 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/domain/epp_DomainRenewOperations.java,v 1.1 2004/12/07 15:27:50 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2004/12/07 15:27:50 $<br>
 * @see org.openrtk.idl.epprtk.domain.epp_DomainRenew
 */
public interface epp_DomainRenewOperations  extends org.openrtk.idl.epprtk.epp_ActionOperations
{
  /**
   ...
   */
  void setRequestData (org.openrtk.idl.epprtk.domain.epp_DomainRenewReq parms);
  /**
   ...
   */
  org.openrtk.idl.epprtk.domain.epp_DomainRenewRsp getResponseData ();
