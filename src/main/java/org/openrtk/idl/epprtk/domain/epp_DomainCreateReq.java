 ...
 * in the registry.</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/domain/epp_DomainCreateReq.java,v 1.1 2004/12/07 15:27:50 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
...
public class epp_DomainCreateReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_DomainCreateReq (org.openrtk.idl.epprtk.epp_Command _m_cmd, String _m_name, org.openrtk.idl.epprtk.domain.epp_DomainPeriod _m_period, String[] _m_name_servers, String _m_registrant, org.openrtk.idl.epprtk.domain.epp_DomainContact[] _m_contacts, org.openrtk.idl.epprtk.epp_AuthInfo _m_auth_info)
  {
    m_cmd = _m_cmd;
    m_name = _m_name;
    m_period = _m_period;
