 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/domain/epp_DomainTransferReq.java,v 1.1 2004/12/07 15:27:50 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
...
public class epp_DomainTransferReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setTrans(org.openrtk.idl.epprtk.epp_TransferRequest)
   * @see #getTrans()
   */
  public org.openrtk.idl.epprtk.epp_TransferRequest m_trans = null;
  /**
   ...
   */
  public epp_DomainTransferReq (org.openrtk.idl.epprtk.epp_Command _m_cmd, org.openrtk.idl.epprtk.epp_TransferRequest _m_trans, String _m_name, org.openrtk.idl.epprtk.domain.epp_DomainPeriod _m_period)
  {
    m_cmd = _m_cmd;
    m_trans = _m_trans;
    m_name = _m_name;
   ...
   * @see #m_trans
   */
  public void setTrans(org.openrtk.idl.epprtk.epp_TransferRequest value) { m_trans = value; }
  /**
   * Accessor method for the common and gereric transfer request element
   * @return The domain transfer request object
   * @see #m_trans
   */
  public org.openrtk.idl.epprtk.epp_TransferRequest getTrans() { return m_trans; }
