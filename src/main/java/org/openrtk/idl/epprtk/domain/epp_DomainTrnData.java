...
/**
 * FIXME!</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/domain/epp_DomainTrnData.java,v 1.1 2004/12/07 15:27:50 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2004/12/07 15:27:50 $<br>
 * @see org.openrtk.idl.epprtk.domain.epp_DomainInfoReq
 */

public class epp_DomainTrnData extends org.omg.CORBA.portable.ObjectImpl implements org.omg.CORBA.portable.IDLEntity, org.openrtk.idl.epprtk.epp_PollResData 
{

  /**
   * Constant variable defined by IDLs.</p>
   * Used when this classes is used to hold the poll response
   * data pertaining to domain transfer notifications.  The value
   ...
   * @see #setTransferStatus(org.openrtk.idl.epprtk.epp_TransferStatusType)
   * @see #getTransferStatus()
   */
  public org.openrtk.idl.epprtk.epp_TransferStatusType m_transfer_status = null;
  /**
   ...
   */
  public epp_DomainTrnData (String _m_name, org.openrtk.idl.epprtk.epp_TransferStatusType _m_transfer_status, String _m_request_client_id, String _m_action_client_id, String _m_request_date, String _m_action_date, String _m_expiration_date)
  {
    m_name = _m_name;
   ...
   */
  public void setTransferStatus(org.openrtk.idl.epprtk.epp_TransferStatusType value) { m_transfer_status = value; }
  /**
   * Accessor method for the transfer status associated with the domain object
   * @return The domain transfer status
   * @see #m_transfer_status
   */
  public org.openrtk.idl.epprtk.epp_TransferStatusType getTransferStatus() { return m_transfer_status; }
