 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/domain/epp_DomainUpdateRsp.java,v 1.1 2004/12/07 15:27:50 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
...
public class epp_DomainUpdateRsp implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_DomainUpdateRsp (org.openrtk.idl.epprtk.epp_Response _m_rsp)
  {
    m_rsp = _m_rsp;
  } // ctor
