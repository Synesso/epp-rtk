 ...
 * command extensions.
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/epp_ExtensionOperations.java,v 1.1 2004/12/07 15:27:49 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
...
public interface epp_ExtensionOperations 
{
   ...
   */
  String toXML () throws org.openrtk.idl.epprtk.epp_XMLException;
  /**
   ...
   */
  void fromXML (String xml) throws org.openrtk.idl.epprtk.epp_XMLException;
