 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/contact/epp_ContactTransferReq.java,v 1.1 2004/12/07 15:27:49 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
...
public class epp_ContactTransferReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_ContactTransferReq (org.openrtk.idl.epprtk.epp_Command _m_cmd, org.openrtk.idl.epprtk.epp_TransferRequest _m_trans, String _m_id)
  {
    m_cmd = _m_cmd;
    m_trans = _m_trans;
    m_id = _m_id;
