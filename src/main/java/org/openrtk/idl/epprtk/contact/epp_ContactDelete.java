 ...
 * IDL classes.
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/contact/epp_ContactDelete.java,v 1.1 2004/12/07 15:27:49 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2004/12/07 15:27:49 $<br>
 * @see com.tucows.oxrs.epprtk.rtk.xml.EPPContactDelete
 */
public interface epp_ContactDelete extends epp_ContactDeleteOperations, org.openrtk.idl.epprtk.epp_Action, org.omg.CORBA.portable.IDLEntity 
{
