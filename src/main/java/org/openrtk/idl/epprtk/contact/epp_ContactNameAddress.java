 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/contact/epp_ContactNameAddress.java,v 1.1 2004/12/07 15:27:49 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
...
public class epp_ContactNameAddress implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setType(org.openrtk.idl.epprtk.contact.epp_ContactPostalInfoType)
   * @see #getType()
   */
  public org.openrtk.idl.epprtk.contact.epp_ContactPostalInfoType m_type = null;
  /**
   ...
   * @see #setAddress(org.openrtk.idl.epprtk.contact.epp_ContactAddress)
   * @see #getAddress()
   */
  public org.openrtk.idl.epprtk.contact.epp_ContactAddress m_address = null;
   ...
   */
  public epp_ContactNameAddress (org.openrtk.idl.epprtk.contact.epp_ContactPostalInfoType _m_type, String _m_name, String _m_org, org.openrtk.idl.epprtk.contact.epp_ContactAddress _m_address)
  {
    m_type = _m_type;
    m_name = _m_name;
    m_org = _m_org;
   ...
   * @see #m_type
   */
  public void setType(org.openrtk.idl.epprtk.contact.epp_ContactPostalInfoType value) { m_type = value; }
  /**
   * Accessor method for the address' type
   * @return The address type (international or local)
   * @see #m_type
   */
  public org.openrtk.idl.epprtk.contact.epp_ContactPostalInfoType getType() { return m_type; }
   ...
   * @see #m_address
   */
  public void setAddress(org.openrtk.idl.epprtk.contact.epp_ContactAddress value) { m_address = value; }
  /**
   * Accessor method for the contact's address information
   * @return The contact's address
   * @see #m_address
   */
  public org.openrtk.idl.epprtk.contact.epp_ContactAddress getAddress() { return m_address; }
