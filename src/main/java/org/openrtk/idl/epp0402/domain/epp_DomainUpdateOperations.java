 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0402/domain/epp_DomainUpdateOperations.java,v 1.1 2003/03/21 16:35:42 tubadanm Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2003/03/21 16:35:42 $<br>
 * @see org.openrtk.idl.epp0402.domain.epp_DomainUpdate
 */
public interface epp_DomainUpdateOperations  extends org.openrtk.idl.epp0402.epp_ActionOperations
{
  /**
   ...
   */
  void setRequestData (org.openrtk.idl.epp0402.domain.epp_DomainUpdateReq parms);
  /**
   ...
   */
  org.openrtk.idl.epp0402.domain.epp_DomainUpdateRsp getResponseData ();
