 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0402/domain/epp_DomainDeleteOperations.java,v 1.1 2003/03/21 16:35:41 tubadanm Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2003/03/21 16:35:41 $<br>
 * @see org.openrtk.idl.epp0402.domain.epp_DomainDelete
 */
public interface epp_DomainDeleteOperations  extends org.openrtk.idl.epp0402.epp_ActionOperations
{
  /**
   ...
   */
  void setRequestData (org.openrtk.idl.epp0402.domain.epp_DomainDeleteReq parms);
  /**
   ...
   */
  org.openrtk.idl.epp0402.domain.epp_DomainDeleteRsp getResponseData ();
