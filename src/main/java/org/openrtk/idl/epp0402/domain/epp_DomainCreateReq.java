 ...
 * in the registry.</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0402/domain/epp_DomainCreateReq.java,v 1.2 2003/09/10 21:29:55 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
 * $Date: 2003/09/10 21:29:55 $<br>
 * @see com.tucows.oxrs.epp0402.rtk.xml.EPPDomainCreate
 * @see org.openrtk.idl.epp0402.domain.epp_DomainCreateRsp
 */
public class epp_DomainCreateReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setPeriod(org.openrtk.idl.epp0402.domain.epp_DomainPeriod)
   * @see #getPeriod()
   */
  public org.openrtk.idl.epp0402.domain.epp_DomainPeriod m_period = null;
  /**
   ...
   */
  public epp_DomainCreateReq (org.openrtk.idl.epp0402.epp_Command _m_cmd, String _m_name, org.openrtk.idl.epp0402.domain.epp_DomainPeriod _m_period, String[] _m_name_servers, String _m_registrant, org.openrtk.idl.epp0402.domain.epp_DomainContact[] _m_contacts, org.openrtk.idl.epp0402.epp_AuthInfo _m_auth_info)
  {
    m_cmd = _m_cmd;
    m_name = _m_name;
    m_period = _m_period;
   ...
   * @see #m_period
   */
  public void setPeriod(org.openrtk.idl.epp0402.domain.epp_DomainPeriod value) { m_period = value; }
  /**
   * Accessor method for the registration period of the domain object
   * @return The domain period
   * @see #m_period
   */
  public org.openrtk.idl.epp0402.domain.epp_DomainPeriod getPeriod() { return m_period; }
