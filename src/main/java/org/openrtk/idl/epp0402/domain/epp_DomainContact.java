 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0402/domain/epp_DomainContact.java,v 1.1 2003/03/21 16:35:41 tubadanm Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2003/03/21 16:35:41 $<br>
 * @see org.openrtk.idl.epp0402.domain.epp_DomainUpdateAddRemove
 * @see org.openrtk.idl.epp0402.domain.epp_DomainCreateReq
...
public class epp_DomainContact implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setType(org.openrtk.idl.epp0402.domain.epp_DomainContactType)
   * @see #getType()
   */
  public org.openrtk.idl.epp0402.domain.epp_DomainContactType m_type = null;
  /**
   ...
   */
  public epp_DomainContact (org.openrtk.idl.epp0402.domain.epp_DomainContactType _m_type, String _m_id)
  {
    m_type = _m_type;
    m_id = _m_id;
  } // ctor
   ...
   * @see #m_type
   */
  public void setType(org.openrtk.idl.epp0402.domain.epp_DomainContactType value) { m_type = value; }
  /**
   * Accessor method for the type of the domain contact
   * @return The domain contact type
   * @see #m_type
   */
  public org.openrtk.idl.epp0402.domain.epp_DomainContactType getType() { return m_type; }
