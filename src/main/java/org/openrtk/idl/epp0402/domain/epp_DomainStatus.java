 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0402/domain/epp_DomainStatus.java,v 1.1 2003/03/21 16:35:41 tubadanm Exp $<br>
 * $Revision: 1.1 $<br>
...
public class epp_DomainStatus implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setType(org.openrtk.idl.epp0402.domain.epp_DomainStatusType)
   * @see #getType()
   */
  public org.openrtk.idl.epp0402.domain.epp_DomainStatusType m_type = null;
  /**
   ...
   */
  public epp_DomainStatus (org.openrtk.idl.epp0402.domain.epp_DomainStatusType _m_type, String _m_lang, String _m_value)
  {
    m_type = _m_type;
    m_lang = _m_lang;
    m_value = _m_value;
   ...
   * @see #m_type
   */
  public void setType(org.openrtk.idl.epp0402.domain.epp_DomainStatusType value) { m_type = value; }
  /**
   * Accessor method for the type of the domain status
   * @return The domain status type
   * @see #m_type
   */
  public org.openrtk.idl.epp0402.domain.epp_DomainStatusType getType() { return m_type; }
