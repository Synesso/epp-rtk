...
/**
 * Class that contains the elements used to represent the contact update
 * response from the EPP server.</p>
 * Note usually instantiated by the RTK user, but rather by EPPContactUpdate
 * and retrieved using that class' getResponseData() method.</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0402/contact/epp_ContactUpdateRsp.java,v 1.2 2003/09/10 21:29:55 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
 ...
 */
public class epp_ContactUpdateRsp implements org.omg.CORBA.portable.IDLEntity
{
  /**
   ...
   */
  public epp_ContactUpdateRsp (org.openrtk.idl.epp0402.epp_Response _m_rsp)
  {
    m_rsp = _m_rsp;
  } // ctor
