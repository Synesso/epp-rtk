 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0402/contact/epp_ContactNameAddress.java,v 1.1 2003/03/21 16:35:40 tubadanm Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2003/03/21 16:35:40 $<br>
 * @see org.openrtk.idl.epp0402.contact.epp_ContactCreateReq
 * @see org.openrtk.idl.epp0402.contact.epp_ContactInfoRsp
 * @see org.openrtk.idl.epp0402.contact.epp_ContactUpdateChange
 */
public class epp_ContactNameAddress implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setAddress(org.openrtk.idl.epp0402.contact.epp_ContactAddress)
   * @see #getAddress()
   */
  public org.openrtk.idl.epp0402.contact.epp_ContactAddress m_address = null;
   ...
   */
  public epp_ContactNameAddress (String _m_name, String _m_org, org.openrtk.idl.epp0402.contact.epp_ContactAddress _m_address)
  {
    m_name = _m_name;
    m_org = _m_org;
   ...
   * @see #m_address
   */
  public void setAddress(org.openrtk.idl.epp0402.contact.epp_ContactAddress value) { m_address = value; }
  /**
   * Accessor method for the contact's address information
   * @return The contact's address
   * @see #m_address
   */
  public org.openrtk.idl.epp0402.contact.epp_ContactAddress getAddress() { return m_address; }
