 ...
 * an EPP server.</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0604/epp_LoginReq.java,v 1.2 2003/09/10 21:29:57 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
 * $Date: 2003/09/10 21:29:57 $<br>
 * @see com.tucows.oxrs.epp0604.rtk.xml.EPPLogin
 * @see org.openrtk.idl.epp0604.epp_LoginRsp
 */
public class epp_LoginReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_LoginReq (org.openrtk.idl.epp0604.epp_Command _m_cmd, String[] _m_services, String[] _m_extensions)
  {
    m_cmd = _m_cmd;
