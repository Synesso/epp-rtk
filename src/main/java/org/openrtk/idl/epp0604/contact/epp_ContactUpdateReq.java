 ...
 * in the registry.</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0604/contact/epp_ContactUpdateReq.java,v 1.2 2003/09/10 21:29:57 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
 * $Date: 2003/09/10 21:29:57 $<br>
 * @see com.tucows.oxrs.epp0604.rtk.xml.EPPContactUpdate
 * @see org.openrtk.idl.epp0604.contact.epp_ContactUpdateRsp
 */
public class epp_ContactUpdateReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setAdd(org.openrtk.idl.epp0604.contact.epp_ContactUpdateAddRemove)
   * @see #getAdd()
   */
  public org.openrtk.idl.epp0604.contact.epp_ContactUpdateAddRemove m_add = null;
  /**
   * The remove element that contains attribute values to be removed from the contact object.
   * @see #setRemove(org.openrtk.idl.epp0604.contact.epp_ContactUpdateAddRemove)
   * @see #getRemove()
   */
  public org.openrtk.idl.epp0604.contact.epp_ContactUpdateAddRemove m_remove = null;
  /**
   * The change element that contains attribute values to be changed in the contact object.
   * @see #setChange(org.openrtk.idl.epp0604.contact.epp_ContactUpdateChange)
   * @see #getChange()
   */
  public org.openrtk.idl.epp0604.contact.epp_ContactUpdateChange m_change = null;
   ...
   */
  public epp_ContactUpdateReq (org.openrtk.idl.epp0604.epp_Command _m_cmd, String _m_id, org.openrtk.idl.epp0604.contact.epp_ContactUpdateAddRemove _m_add, org.openrtk.idl.epp0604.contact.epp_ContactUpdateAddRemove _m_remove, org.openrtk.idl.epp0604.contact.epp_ContactUpdateChange _m_change)
  {
    m_cmd = _m_cmd;
    m_id = _m_id;
    m_add = _m_add;
   ...
   * @see #m_add
   */
  public void setAdd(org.openrtk.idl.epp0604.contact.epp_ContactUpdateAddRemove value) { m_add = value; }
  /**
   * Accessor method for the add element that contains attribute values to be added to the contact object
   * @return The add element
   * @see #m_add
   */
  public org.openrtk.idl.epp0604.contact.epp_ContactUpdateAddRemove getAdd() { return m_add; }
   ...
   * @see #m_remove
   */
  public void setRemove(org.openrtk.idl.epp0604.contact.epp_ContactUpdateAddRemove value) { m_remove = value; }
  /**
   * Accessor method for the remove element that contains attribute values to be removed from the contact object
   * @return The remove element
   * @see #m_remove
   */
  public org.openrtk.idl.epp0604.contact.epp_ContactUpdateAddRemove getRemove() { return m_remove; }
   ...
   * @see #m_change
   */
  public void setChange(org.openrtk.idl.epp0604.contact.epp_ContactUpdateChange value) { m_change = value; }
  /**
   * Accessor method for the change element that contains attribute values to be changed in the contact object
   * @return The change element
   * @see #m_change
   */
  public org.openrtk.idl.epp0604.contact.epp_ContactUpdateChange getChange() { return m_change; }
