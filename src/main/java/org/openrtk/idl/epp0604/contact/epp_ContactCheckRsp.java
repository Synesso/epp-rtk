 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0604/contact/epp_ContactCheckRsp.java,v 1.2 2003/09/10 21:29:57 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
...
public class epp_ContactCheckRsp implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #getResults()
   * @see com.tucows.oxrs.epp0604.rtk.xml.EPPXMLBase#getCheckResultFor(epp_CheckResult[], String)
   */
  public org.openrtk.idl.epp0604.epp_CheckResult m_results[] = null;
   ...
   */
  public epp_ContactCheckRsp (org.openrtk.idl.epp0604.epp_Response _m_rsp, org.openrtk.idl.epp0604.epp_CheckResult[] _m_results)
  {
    m_rsp = _m_rsp;
   ...
   * @see #m_results
   */
  public void setResults(org.openrtk.idl.epp0604.epp_CheckResult[] value) { m_results = value; }
  /**
   * Accessor method for the contact check results
   * @return The value for the contact check results array
   * @see #m_results
   */
  public org.openrtk.idl.epp0604.epp_CheckResult[] getResults() { return m_results; }
