 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0604/domain/epp_DomainRenewOperations.java,v 1.1 2003/03/21 15:55:19 tubadanm Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2003/03/21 15:55:19 $<br>
 * @see org.openrtk.idl.epp0604.domain.epp_DomainRenew
 */
public interface epp_DomainRenewOperations  extends org.openrtk.idl.epp0604.epp_ActionOperations
{
  /**
   ...
   */
  void setRequestData (org.openrtk.idl.epp0604.domain.epp_DomainRenewReq parms);
  /**
   ...
   */
  org.openrtk.idl.epp0604.domain.epp_DomainRenewRsp getResponseData ();
