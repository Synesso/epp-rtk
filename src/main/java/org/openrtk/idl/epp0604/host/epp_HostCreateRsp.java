 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0604/host/epp_HostCreateRsp.java,v 1.2 2003/09/10 21:29:58 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
...
public class epp_HostCreateRsp implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_HostCreateRsp (org.openrtk.idl.epp0604.epp_Response _m_rsp, String _m_name, String _m_creation_date)
  {
    m_rsp = _m_rsp;
    m_name = _m_name;
