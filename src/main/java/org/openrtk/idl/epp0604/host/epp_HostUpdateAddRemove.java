 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0604/host/epp_HostUpdateAddRemove.java,v 1.1 2003/03/21 15:55:25 tubadanm Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2003/03/21 15:55:25 $<br>
 * @see org.openrtk.idl.epp0604.host.epp_HostUpdateReq#setAdd(epp_HostUpdateAddRemove)
 * @see org.openrtk.idl.epp0604.host.epp_HostUpdateReq#setRemove(epp_HostUpdateAddRemove)
 */
public class epp_HostUpdateAddRemove implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setStatus(org.openrtk.idl.epp0604.host.epp_HostStatus[])
   * @see #getStatus()
   */
  public org.openrtk.idl.epp0604.host.epp_HostStatus m_status[] = null;
   ...
   */
  public epp_HostUpdateAddRemove (org.openrtk.idl.epp0604.host.epp_HostAddress[] _m_addresses, org.openrtk.idl.epp0604.host.epp_HostStatus[] _m_status)
  {
   ...
   * @see #m_status
   */
  public void setStatus(org.openrtk.idl.epp0604.host.epp_HostStatus[] value) { m_status = value; }
  /**
   * Accessor method for the array of host status values
   * @return The array of host status values
   * @see #m_status
   */
  public org.openrtk.idl.epp0604.host.epp_HostStatus[] getStatus() { return m_status; }
