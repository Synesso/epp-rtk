...
public class epp_ResultData implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #m_status
   */
  public void setStatus(org.openrtk.idl.epp0604.epp_StatusResultData value) { m_status = value; }
  /**
   * Accessor method for the status result data
   * @return The status result data
   * @see #m_status
   */
  public org.openrtk.idl.epp0604.epp_StatusResultData getStatus() { return m_status; }
