 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0604/epp_MessageQueue.java,v 1.1 2003/03/21 15:54:15 tubadanm Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2003/03/21 15:54:15 $<br>
 * @see org.openrtk.idl.epp0604.epp_Response#setMessageQueue(epp_MessageQueue)
 */
public class epp_MessageQueue implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_MessageQueue (int _m_count, String _m_queue_date, String _m_msg, String _m_id)
  {
    m_count = _m_count;
