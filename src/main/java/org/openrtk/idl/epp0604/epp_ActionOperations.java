 ...
 * EPP commands.</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0604/epp_ActionOperations.java,v 1.1 2003/03/21 15:53:44 tubadanm Exp $<br>
 * $Revision: 1.1 $<br>
...
public interface epp_ActionOperations 
{
   ...
   */
  String toXML () throws org.openrtk.idl.epp0604.epp_Exception, org.openrtk.idl.epp0604.epp_XMLException;
  /**
   ...
   * @throws epp_Exception if an error occurs.
   */
  void fromXML (String xml) throws org.openrtk.idl.epp0604.epp_Exception, org.openrtk.idl.epp0604.epp_XMLException;
