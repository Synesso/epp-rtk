 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/host/epp_HostCheckRsp.java,v 1.1 2004/12/07 15:27:50 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
...
public class epp_HostCheckRsp implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_HostCheckRsp (org.openrtk.idl.epprtk.epp_Response _m_rsp, org.openrtk.idl.epprtk.epp_CheckResult[] _m_results)
  {
    m_rsp = _m_rsp;
