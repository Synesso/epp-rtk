 ...
 * in the registry.</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/host/epp_HostDeleteReq.java,v 1.1 2004/12/07 15:27:50 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
...
public class epp_HostDeleteReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_HostDeleteReq (org.openrtk.idl.epprtk.epp_Command _m_cmd, String _m_name)
  {
    m_cmd = _m_cmd;
    m_name = _m_name;
  } // ctor
