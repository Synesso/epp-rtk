 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/host/epp_HostStatus.java,v 1.1 2004/12/07 15:27:50 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2004/12/07 15:27:50 $<br>
 * @see org.openrtk.idl.epprtk.host.epp_HostInfoRsp
 * @see org.openrtk.idl.epprtk.host.epp_HostUpdateAddRemove
 */
public class epp_HostStatus implements org.omg.CORBA.portable.IDLEntity
{
  /**
   * The type of the host status.
   * @see #setType(org.openrtk.idl.epprtk.host.epp_HostStatusType)
   * @see #getType()
   */
  public org.openrtk.idl.epprtk.host.epp_HostStatusType m_type = null;
  /**
   ...
   */
  public epp_HostStatus (org.openrtk.idl.epprtk.host.epp_HostStatusType _m_type, String _m_lang, String _m_value)
  {
    m_type = _m_type;
    m_lang = _m_lang;
    m_value = _m_value;
   ...
   * @see #m_type
   */
  public void setType(org.openrtk.idl.epprtk.host.epp_HostStatusType value) { m_type = value; }
  /**
   * Accessor method for the type of the host status
   * @return The host status type
   * @see #m_type
   */
  public org.openrtk.idl.epprtk.host.epp_HostStatusType getType() { return m_type; }
