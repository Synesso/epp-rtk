 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/epp_AuthInfo.java,v 1.1 2004/12/07 15:27:49 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
 ...
 * @see org.openrtk.idl.epprtk.domain.epp_DomainUpdateChange
 */
public class epp_AuthInfo implements org.omg.CORBA.portable.IDLEntity
{
  /**
   * The authorization information type.
   * @see #setType(org.openrtk.idl.epprtk.epp_AuthInfoType)
   * @see #getType()
   */
  public org.openrtk.idl.epprtk.epp_AuthInfoType m_type = null;
  /**
   ...
   */
  public epp_AuthInfo (org.openrtk.idl.epprtk.epp_AuthInfoType _m_type, String _m_roid, String _m_value)
  {
    m_type = _m_type;
    m_roid = _m_roid;
    m_value = _m_value;
   ...
   * @see #m_type
   */
  public void setType(org.openrtk.idl.epprtk.epp_AuthInfoType value) { m_type = value; }
  /**
   * Accessor method for the authorization information type
   * @return The authorization information type
   * @see #m_type
   */
  public org.openrtk.idl.epprtk.epp_AuthInfoType getType() { return m_type; }
