 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/epp_Greeting.java,v 1.1 2004/12/07 15:27:49 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2004/12/07 15:27:49 $<br>
 * @see com.tucows.oxrs.epprtk.rtk.xml.EPPGreeting#getResponseData()
 * @see com.tucows.oxrs.epprtk.rtk.EPPClient#getGreeting()
 * @see com.tucows.oxrs.epprtk.rtk.EPPClient#hello()
 */
public class epp_Greeting implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setSvcMenu(org.openrtk.idl.epprtk.epp_ServiceMenu)
   * @see #getSvcMenu()
   */
  public org.openrtk.idl.epprtk.epp_ServiceMenu m_svc_menu = null;
  /**
   * The data collection policy of the server.
   * @see #setDcp(org.openrtk.idl.epprtk.epp_DataCollectionPolicy)
   * @see #getDcp()
   */
  public org.openrtk.idl.epprtk.epp_DataCollectionPolicy m_dcp = null;
   ...
   */
  public epp_Greeting (String _m_server_id, String _m_server_date, org.openrtk.idl.epprtk.epp_ServiceMenu _m_svc_menu, org.openrtk.idl.epprtk.epp_DataCollectionPolicy _m_dcp)
  {
   ...
   * @see #m_svc_menu
   */
  public void setSvcMenu(org.openrtk.idl.epprtk.epp_ServiceMenu value) { m_svc_menu = value; }
  /**
   * Accessor method for the services offered by the server
   * @return The service element
   * @see #m_svc_menu
   */
  public org.openrtk.idl.epprtk.epp_ServiceMenu getSvcMenu() { return m_svc_menu; }
   ...
   * @see #m_dcp
   */
  public void setDcp(org.openrtk.idl.epprtk.epp_DataCollectionPolicy value) { m_dcp = value; }
  /**
   * Accessor method for the data collection policy of the server
   * @return The data collection policy of the server
   * @see #m_dcp
   */
  public org.openrtk.idl.epprtk.epp_DataCollectionPolicy getDcp() { return m_dcp; }
