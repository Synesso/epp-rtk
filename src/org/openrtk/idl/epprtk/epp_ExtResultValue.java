 ...
 * a reason text.</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/epp_ExtResultValue.java,v 1.1 2004/12/07 15:27:49 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2004/12/07 15:27:49 $<br>
 * @see org.openrtk.idl.epprtk.epp_Result#setExtValues(epp_ExtResultValue[])
 */
public class epp_ExtResultValue implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public org.openrtk.idl.epprtk.epp_ResultValue m_value = null;
  /**
   ...
   */
  public epp_ExtResultValue (org.openrtk.idl.epprtk.epp_ResultValue _m_value, String _m_reason)
  {
    m_value = _m_value;
    m_reason = _m_reason;
  } // ctor
   ...
   */
  public void setValue(org.openrtk.idl.epprtk.epp_ResultValue value) { m_value = value; }
  /**
   * The accessor for retrieving the offencing XML element.
   * @return value The offending XML element
   */
  public org.openrtk.idl.epprtk.epp_ResultValue getValue() { return m_value; }
