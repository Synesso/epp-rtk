 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/domain/epp_DomainUpdateChange.java,v 1.1 2004/12/07 15:27:50 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2004/12/07 15:27:50 $<br>
 * @see org.openrtk.idl.epprtk.domain.epp_DomainUpdateReq#setChange(epp_DomainUpdateChange)
 */
public class epp_DomainUpdateChange implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_DomainUpdateChange (String _m_registrant, org.openrtk.idl.epprtk.epp_AuthInfo _m_auth_info)
  {
