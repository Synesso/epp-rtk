 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/domain/epp_DomainCreateRsp.java,v 1.1 2004/12/07 15:27:50 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
...
public class epp_DomainCreateRsp implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_DomainCreateRsp (org.openrtk.idl.epprtk.epp_Response _m_rsp, String _m_name, String _m_creation_date, String _m_expiration_date)
  {
    m_rsp = _m_rsp;
    m_name = _m_name;
