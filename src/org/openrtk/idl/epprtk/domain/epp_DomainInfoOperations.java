 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/domain/epp_DomainInfoOperations.java,v 1.1 2004/12/07 15:27:50 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2004/12/07 15:27:50 $<br>
 * @see org.openrtk.idl.epprtk.domain.epp_DomainInfo
 */
public interface epp_DomainInfoOperations  extends org.openrtk.idl.epprtk.epp_ActionOperations
{
  /**
   ...
   */
  void setRequestData (org.openrtk.idl.epprtk.domain.epp_DomainInfoReq parms);
  /**
   ...
   */
  org.openrtk.idl.epprtk.domain.epp_DomainInfoRsp getResponseData ();
