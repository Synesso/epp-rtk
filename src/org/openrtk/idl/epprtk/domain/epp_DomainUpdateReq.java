...
public class epp_DomainUpdateReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #m_add
   */
  public void setAdd(org.openrtk.idl.epprtk.domain.epp_DomainUpdateAddRemove value) { m_add = value; }
  /**
   * Accessor method for the add element that contains attribute values to be added to the domain object
   * @return The add element
   * @see #m_add
   */
  public org.openrtk.idl.epprtk.domain.epp_DomainUpdateAddRemove getAdd() { return m_add; }
   ...
   * @see #m_change
   */
  public void setChange(org.openrtk.idl.epprtk.domain.epp_DomainUpdateChange value) { m_change = value; }
  /**
   * Accessor method for the change element that contains attribute values to be changed
   * @return The change element
   * @see #m_change
   */
  public org.openrtk.idl.epprtk.domain.epp_DomainUpdateChange getChange() { return m_change; }
   ...
   * @see #m_remove
   */
  public void setRemove(org.openrtk.idl.epprtk.domain.epp_DomainUpdateAddRemove value) { m_remove = value; }
  /**
   * Accessor method for the remove element that contains attribute values to be removed from the domain object
   * @return The remove element
   * @see #m_remove
   */
  public org.openrtk.idl.epprtk.domain.epp_DomainUpdateAddRemove getRemove() { return m_remove; }
