 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/contact/epp_ContactCheckRsp.java,v 1.1 2004/12/07 15:27:49 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
...
public class epp_ContactCheckRsp implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #getResults()
   * @see com.tucows.oxrs.epprtk.rtk.xml.EPPXMLBase#getCheckResultFor(epp_CheckResult[], String)
   */
  public org.openrtk.idl.epprtk.epp_CheckResult m_results[] = null;
   ...
   */
  public epp_ContactCheckRsp (org.openrtk.idl.epprtk.epp_Response _m_rsp, org.openrtk.idl.epprtk.epp_CheckResult[] _m_results)
  {
    m_rsp = _m_rsp;
   ...
   * @see #m_results
   */
  public void setResults(org.openrtk.idl.epprtk.epp_CheckResult[] value) { m_results = value; }
  /**
   * Accessor method for the contact check results
   * @return The value for the contact check results array
   * @see #m_results
   */
  public org.openrtk.idl.epprtk.epp_CheckResult[] getResults() { return m_results; }
