 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/contact/epp_ContactStatus.java,v 1.1 2004/12/07 15:27:49 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2004/12/07 15:27:49 $<br>
 * @see org.openrtk.idl.epprtk.contact.epp_ContactInfoRsp
 * @see org.openrtk.idl.epprtk.contact.epp_ContactUpdateAddRemove
 */
public class epp_ContactStatus implements org.omg.CORBA.portable.IDLEntity
{
  /**
   * The type of the contact status.
   * @see #setType(org.openrtk.idl.epprtk.contact.epp_ContactStatusType)
   * @see #getType()
   */
  public org.openrtk.idl.epprtk.contact.epp_ContactStatusType m_type = null;
  /**
   ...
   */
  public epp_ContactStatus (org.openrtk.idl.epprtk.contact.epp_ContactStatusType _m_type, String _m_lang, String _m_value)
  {
    m_type = _m_type;
    m_lang = _m_lang;
    m_value = _m_value;
   ...
   * @see #m_type
   */
  public void setType(org.openrtk.idl.epprtk.contact.epp_ContactStatusType value) { m_type = value; }
  /**
   * Accessor method for the type of the contact status
   * @return The contact status type
   * @see #m_type
   */
  public org.openrtk.idl.epprtk.contact.epp_ContactStatusType getType() { return m_type; }
