...
/**
 * FIXME!</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/contact/epp_ContactTrnData.java,v 1.1 2004/12/07 15:27:49 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2004/12/07 15:27:49 $<br>
 * @see org.openrtk.idl.epprtk.contact.epp_ContactInfoReq
 */

public class epp_ContactTrnData extends org.omg.CORBA.portable.ObjectImpl implements org.omg.CORBA.portable.IDLEntity, org.openrtk.idl.epprtk.epp_PollResData 
{
   ...
   */
  public epp_ContactTrnData (String _m_id, org.openrtk.idl.epprtk.epp_TransferStatusType _m_transfer_status, String _m_request_client_id, String _m_action_client_id, String _m_request_date, String _m_action_date)
  {
    m_id = _m_id;
