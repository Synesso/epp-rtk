 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/contact/epp_ContactCheckReq.java,v 1.1 2004/12/07 15:27:49 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
...
public class epp_ContactCheckReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_ContactCheckReq (org.openrtk.idl.epprtk.epp_Command _m_cmd, String[] _m_ids)
  {
    m_cmd = _m_cmd;
    m_ids = _m_ids;
  } // ctor
