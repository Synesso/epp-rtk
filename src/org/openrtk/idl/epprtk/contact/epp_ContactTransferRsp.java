 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/contact/epp_ContactTransferRsp.java,v 1.1 2004/12/07 15:27:49 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2004/12/07 15:27:49 $<br>
 * @see com.tucows.oxrs.epprtk.rtk.xml.EPPContactTransfer
...
public class epp_ContactTransferRsp implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setTrnData(org.openrtk.idl.epprtk.contact.epp_ContactTrnData)
   * @see #getTrnData()
   */
  public org.openrtk.idl.epprtk.contact.epp_ContactTrnData m_trn_data = null;
   ...
   */
  public epp_ContactTransferRsp (org.openrtk.idl.epprtk.epp_Response _m_rsp, String _m_id, org.openrtk.idl.epprtk.epp_TransferStatusType _m_transfer_status, String _m_request_client_id, String _m_request_date, String _m_action_client_id, String _m_action_date)
  {
    m_rsp = _m_rsp;
    m_trn_data = new org.openrtk.idl.epprtk.contact.epp_ContactTrnData();
   ...
   */
  public epp_ContactTransferRsp (org.openrtk.idl.epprtk.epp_Response _m_rsp, org.openrtk.idl.epprtk.contact.epp_ContactTrnData _m_trn_data)
  {
    m_rsp = _m_rsp;
   ...
   * @see #m_trn_data
   */
  public void setTrnData(org.openrtk.idl.epprtk.contact.epp_ContactTrnData value) { m_trn_data = value; }
  /**
   * Accessor method for the transfer data of the contact object in the registry
   * @return The contact's transfer data
   * @see #m_trn_data
   */
  public org.openrtk.idl.epprtk.contact.epp_ContactTrnData getTrnData() { return m_trn_data; }
   ...
   * @see #m_trn_data
   * @deprecated Please use setTrnData(org.openrtk.idl.epprtk.contact.epp_ContactTrnData) instead
   */
   ...
   * @deprecated Please use setTrnData(org.openrtk.idl.epprtk.contact.epp_ContactTrnData) instead
   */
  public void setTransferStatus(org.openrtk.idl.epprtk.epp_TransferStatusType value) { if ( m_trn_data == null ) { m_trn_data = new epp_ContactTrnData(); } m_trn_data.m_transfer_status = value; }
  /**
   * Accessor method for the transfer status associated with the contact object
   ...
   * @deprecated Please use getTrnData() instead
   */
  public org.openrtk.idl.epprtk.epp_TransferStatusType getTransferStatus() { return m_trn_data == null ? null : m_trn_data.m_transfer_status; }
