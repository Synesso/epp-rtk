 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/epp_PanData.java,v 1.1 2004/12/07 15:27:49 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
...
public abstract class epp_PanData extends org.omg.CORBA.portable.ObjectImpl implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * pending action.
   */
  public org.openrtk.idl.epprtk.epp_TransID m_trid;
  /**
   ...
   */
  public epp_PanData (boolean _m_result, org.openrtk.idl.epprtk.epp_TransID _m_trid, String _m_date)
  {
    m_result = _m_result;
    m_trid = _m_trid;
    m_date = _m_date;
   ...
   * @see #m_trid
   */
  public void setTrid(org.openrtk.idl.epprtk.epp_TransID value) { m_trid = value; }
  /**
   * Accessor method for the client and server TRID pair associated with the pending action
   * @return The client/server TRID pair
   * @see #m_trid
   */
  public org.openrtk.idl.epprtk.epp_TransID getTrid() { return m_trid; }
