 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/epp_PollReq.java,v 1.1 2004/12/07 15:27:49 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2004/12/07 15:27:49 $<br>
 * @see com.tucows.oxrs.epprtk.rtk.xml.EPPPoll
 * @see org.openrtk.idl.epprtk.epp_PollRsp
 */
public class epp_PollReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setOp(org.openrtk.idl.epprtk.epp_PollOpType)
   * @see #getOp()
   */
  public org.openrtk.idl.epprtk.epp_PollOpType m_op = null;
  /**
   ...
   */
  public epp_PollReq (org.openrtk.idl.epprtk.epp_Command _m_cmd, org.openrtk.idl.epprtk.epp_PollOpType _m_op, String _m_msgID)
  {
    m_cmd = _m_cmd;
    m_op = _m_op;
    m_msgID = _m_msgID;
   ...
   * @see #m_op
   */
  public void setOp(org.openrtk.idl.epprtk.epp_PollOpType value) { m_op = value; }
  /**
   * Accessor method for the poll operation type
   * @return The poll operation type
   * @see #m_op
   */
  public org.openrtk.idl.epprtk.epp_PollOpType getOp() { return m_op; }
