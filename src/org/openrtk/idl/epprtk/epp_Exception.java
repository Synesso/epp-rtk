 ...
 * in epp_Action.
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/epp_Exception.java,v 1.1 2004/12/07 15:27:49 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
...
public class epp_Exception extends org.omg.CORBA.UserException implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setDetails(org.openrtk.idl.epprtk.epp_Result[])
   * @see #getDetails()
   */
  public org.openrtk.idl.epprtk.epp_Result m_details[] = null;
   ...
   */
  public epp_Exception (org.openrtk.idl.epprtk.epp_Result[] _m_details)
  {
   ...
   * @param _m_details The array of error details
   */
  public epp_Exception (org.openrtk.idl.epprtk.epp_Result[] _m_details, org.openrtk.idl.epprtk.epp_TransID _m_trans_id, String[] _m_ext_strings)
  {
    m_details = _m_details;
   ...
   * @see #m_details
   */
  public void setDetails(org.openrtk.idl.epprtk.epp_Result[] value) { m_details = value; }
  /**
   * Accessor method for the array of error details
   * @return The array of error details
   * @see #m_details
   */
  public org.openrtk.idl.epprtk.epp_Result[] getDetails() { return m_details; }
