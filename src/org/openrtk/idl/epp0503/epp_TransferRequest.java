 ...
 * REQUEST.</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0503/epp_TransferRequest.java,v 1.1 2003/03/21 16:18:26 tubadanm Exp $<br>
 * $Revision: 1.1 $<br>
...
public class epp_TransferRequest implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setOp(org.openrtk.idl.epp0503.epp_TransferOpType)
   * @see #getOp()
   */
  public org.openrtk.idl.epp0503.epp_TransferOpType m_op = null;
   ...
   */
  public epp_TransferRequest (org.openrtk.idl.epp0503.epp_AuthInfo _m_auth_info, org.openrtk.idl.epp0503.epp_TransferOpType _m_op)
  {
   ...
   * @see #m_op
   */
  public void setOp(org.openrtk.idl.epp0503.epp_TransferOpType value) { m_op = value; }
  /**
   * Accessor method for the transfer operation type
   * @return The transfer operation type
   * @see #m_op
   */
  public org.openrtk.idl.epp0503.epp_TransferOpType getOp() { return m_op; }
