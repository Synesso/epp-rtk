 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0503/domain/epp_DomainTransferRsp.java,v 1.2 2003/09/10 21:29:57 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
...
public class epp_DomainTransferRsp implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setTrnData(org.openrtk.idl.epp0503.domain.epp_DomainTrnData)
   * @see #getTrnData()
   */
  public org.openrtk.idl.epp0503.domain.epp_DomainTrnData m_trn_data = null;
   ...
   */
  public epp_DomainTransferRsp (org.openrtk.idl.epp0503.epp_Response _m_rsp, String _m_name, org.openrtk.idl.epp0503.epp_TransferStatusType _m_transfer_status, String _m_request_client_id, String _m_action_client_id, String _m_request_date, String _m_action_date, String _m_expiration_date)
  {
    m_rsp = _m_rsp;
    m_trn_data = new org.openrtk.idl.epp0503.domain.epp_DomainTrnData();
   ...
   */
  public epp_DomainTransferRsp (org.openrtk.idl.epp0503.epp_Response _m_rsp, org.openrtk.idl.epp0503.domain.epp_DomainTrnData _m_trn_data)
  {
    m_rsp = _m_rsp;
   ...
   * @see #m_trn_data
   */
  public void setTrnData(org.openrtk.idl.epp0503.domain.epp_DomainTrnData value) { m_trn_data = value; }
  /**
   * Accessor method for the transfer data of the domain object in the registry
   * @return The domain's transfer data
   * @see #m_trn_data
   */
  public org.openrtk.idl.epp0503.domain.epp_DomainTrnData getTrnData() { return m_trn_data; }

  /**
   * Accessor method for the name of the domain object in the registry
   * @param value The domain name
   * @see #m_trn_data
   * @deprecated Please use setTrnData(org.openrtk.idl.epp0503.domain.epp_DomainTrnData) instead
   */
   ...
   * @deprecated Please use setTrnData(org.openrtk.idl.epp0503.domain.epp_DomainTrnData) instead
   */
  public void setTransferStatus(org.openrtk.idl.epp0503.epp_TransferStatusType value) { if ( m_trn_data == null ) { m_trn_data = new epp_DomainTrnData(); } m_trn_data.m_transfer_status = value; }
  /**
   * Accessor method for the transfer status associated with the domain object
