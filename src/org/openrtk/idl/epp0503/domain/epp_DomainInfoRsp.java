 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0503/domain/epp_DomainInfoRsp.java,v 1.2 2003/09/10 21:29:57 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
...
public class epp_DomainInfoRsp implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_DomainInfoRsp (org.openrtk.idl.epp0503.epp_Response _m_rsp, String _m_name, String _m_roid, org.openrtk.idl.epp0503.domain.epp_DomainStatus[] _m_status, String _m_registrant, org.openrtk.idl.epp0503.domain.epp_DomainContact[] _m_contacts, String[] _m_name_servers, String[] _m_hosts, String _m_client_id, String _m_created_by, String _m_created_date, String _m_updated_by, String _m_updated_date, String _m_expiration_date, String _m_transfer_date, org.openrtk.idl.epp0503.epp_AuthInfo _m_auth_info)
  {
    m_rsp = _m_rsp;
    m_name = _m_name;
    m_roid = _m_roid;
