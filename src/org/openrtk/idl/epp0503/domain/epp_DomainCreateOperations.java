 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0503/domain/epp_DomainCreateOperations.java,v 1.1 2003/03/21 16:18:28 tubadanm Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2003/03/21 16:18:28 $<br>
 * @see org.openrtk.idl.epp0503.domain.epp_DomainCreate
 */
public interface epp_DomainCreateOperations  extends org.openrtk.idl.epp0503.epp_ActionOperations
{
  /**
   ...
   */
  void setRequestData (org.openrtk.idl.epp0503.domain.epp_DomainCreateReq parms);
  /**
   ...
   */
  org.openrtk.idl.epp0503.domain.epp_DomainCreateRsp getResponseData ();
