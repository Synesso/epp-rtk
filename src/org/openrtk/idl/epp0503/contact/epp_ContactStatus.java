...
public class epp_ContactStatus implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #m_type
   */
  public void setType(org.openrtk.idl.epp0503.contact.epp_ContactStatusType value) { m_type = value; }
  /**
   * Accessor method for the type of the contact status
   * @return The contact status type
   * @see #m_type
   */
  public org.openrtk.idl.epp0503.contact.epp_ContactStatusType getType() { return m_type; }
