 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0503/epp_PollReq.java,v 1.2 2003/09/10 21:29:56 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
 * $Date: 2003/09/10 21:29:56 $<br>
 * @see com.tucows.oxrs.epp0503.rtk.xml.EPPPoll
 * @see org.openrtk.idl.epp0503.epp_PollRsp
 */
public class epp_PollReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setOp(org.openrtk.idl.epp0503.epp_PollOpType)
   * @see #getOp()
   */
  public org.openrtk.idl.epp0503.epp_PollOpType m_op = null;
  /**
   ...
   */
  public epp_PollReq (org.openrtk.idl.epp0503.epp_Command _m_cmd, org.openrtk.idl.epp0503.epp_PollOpType _m_op, String _m_msgID)
  {
    m_cmd = _m_cmd;
    m_op = _m_op;
    m_msgID = _m_msgID;
   ...
   * @see #m_op
   */
  public void setOp(org.openrtk.idl.epp0503.epp_PollOpType value) { m_op = value; }
  /**
   * Accessor method for the poll operation type
   * @return The poll operation type
   * @see #m_op
   */
  public org.openrtk.idl.epp0503.epp_PollOpType getOp() { return m_op; }
