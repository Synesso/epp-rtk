...
/**
 * Class that contains the elements used to represent the host update
 * response from the EPP server.</p>
 * Note usually instantiated by the RTK user, but rather by EPPHostUpdate
 * and retrieved using that class' getResponseData() method.</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0503/host/epp_HostUpdateRsp.java,v 1.2 2003/09/10 21:29:57 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
 * $Date: 2003/09/10 21:29:57 $<br>
 * @see com.tucows.oxrs.epp0503.rtk.xml.EPPHostUpdate
 * @see org.openrtk.idl.epp0503.host.epp_HostUpdateReq
 */
public class epp_HostUpdateRsp implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_HostUpdateRsp (org.openrtk.idl.epp0503.epp_Response _m_rsp)
  {
    m_rsp = _m_rsp;
  } // ctor
