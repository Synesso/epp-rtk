 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0503/epp_Result.java,v 1.1 2003/03/21 16:18:26 tubadanm Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2003/03/21 16:18:26 $<br>
 * @see org.openrtk.idl.epp0503.epp_Exception
 * @see org.openrtk.idl.epp0503.epp_Response
 */
public class epp_Result implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setData(org.openrtk.idl.epp0503.epp_ResultData)
   * @see #getData()
   */
  public org.openrtk.idl.epp0503.epp_ResultData m_data = null;
   ...
   */
  public epp_Result (short _m_code, String _m_msg, String _m_lang, String _m_id, String[] _m_values, org.openrtk.idl.epp0503.epp_ResultData _m_data)
  {
    m_code = _m_code;
    m_msg = _m_msg;
    m_lang = _m_lang;
   ...
   * @see #m_data
   */
  public void setData(org.openrtk.idl.epp0503.epp_ResultData value) { m_data = value; }
  /**
   * Accessor method for the result data
   * @return The generic result data
   * @see #m_data
   */
  public org.openrtk.idl.epp0503.epp_ResultData getData() { return m_data; }
   ...
   */
  public String toString() { return this.getClass().getName() + ": { m_code ["+m_code+"] m_values ["+(m_values != null ? java.util.Arrays.asList(m_values) : null)+"] m_msg ["+m_msg+"] m_lang ["+m_lang+"] m_id ["+m_id+"] m_data ["+m_data+"] }"; }
