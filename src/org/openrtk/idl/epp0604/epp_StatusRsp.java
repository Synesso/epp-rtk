...
/**
 * Class that contains the elements used to represent the status
 * response from the EPP server.</p>
 * Not usually instantiated by the RTK user, but rather by EPPStatus
 * and retrieved using that class' getResponseData() method.</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0604/epp_StatusRsp.java,v 1.2 2003/09/10 21:29:57 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
 * $Date: 2003/09/10 21:29:57 $<br>
 * @see com.tucows.oxrs.epp0604.rtk.xml.EPPStatus
 */
public class epp_StatusRsp implements org.omg.CORBA.portable.IDLEntity
{
  /**
   ...
   */
  public epp_StatusRsp (org.openrtk.idl.epp0604.epp_Response _m_rsp)
  {
    m_rsp = _m_rsp;
  } // ctor
