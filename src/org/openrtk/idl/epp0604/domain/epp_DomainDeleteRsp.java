 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0604/domain/epp_DomainDeleteRsp.java,v 1.2 2003/09/10 21:29:58 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
...
public class epp_DomainDeleteRsp implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_DomainDeleteRsp (org.openrtk.idl.epp0604.epp_Response _m_rsp)
  {
    m_rsp = _m_rsp;
  } // ctor
