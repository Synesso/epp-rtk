 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0604/domain/epp_DomainPeriod.java,v 1.1 2003/03/21 15:55:18 tubadanm Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2003/03/21 15:55:18 $<br>
...
public class epp_DomainPeriod implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setUnit(org.openrtk.idl.epp0604.domain.epp_DomainPeriodUnitType)
   * @see #getUnit()
   */
  public org.openrtk.idl.epp0604.domain.epp_DomainPeriodUnitType m_unit = null;
  /**
   ...
   */
  public epp_DomainPeriod (org.openrtk.idl.epp0604.domain.epp_DomainPeriodUnitType _m_unit, short _m_value)
  {
    m_unit = _m_unit;
    m_value = _m_value;
  } // ctor
   ...
   * @see #m_unit
   */
  public void setUnit(org.openrtk.idl.epp0604.domain.epp_DomainPeriodUnitType value) { m_unit = value; }
  /**
   * Accessor method for the unit type of the domain registration period
   * @return The unit type of period
   * @see #m_unit
   */
  public org.openrtk.idl.epp0604.domain.epp_DomainPeriodUnitType getUnit() { return m_unit; }
