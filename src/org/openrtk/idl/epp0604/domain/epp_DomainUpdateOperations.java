 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0604/domain/epp_DomainUpdateOperations.java,v 1.1 2003/03/21 15:55:21 tubadanm Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2003/03/21 15:55:21 $<br>
 * @see org.openrtk.idl.epp0604.domain.epp_DomainUpdate
 */
public interface epp_DomainUpdateOperations  extends org.openrtk.idl.epp0604.epp_ActionOperations
{
  /**
   ...
   */
  void setRequestData (org.openrtk.idl.epp0604.domain.epp_DomainUpdateReq parms);
  /**
   ...
   */
  org.openrtk.idl.epp0604.domain.epp_DomainUpdateRsp getResponseData ();
