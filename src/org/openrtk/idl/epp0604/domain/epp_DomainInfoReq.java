 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0604/domain/epp_DomainInfoReq.java,v 1.2 2003/09/10 21:29:58 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
...
public class epp_DomainInfoReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #getHostsType()
   */
  public org.openrtk.idl.epp0604.domain.epp_DomainHostsType m_hosts_type = null;
  /**
   ...
   * @deprecated
   */
  public epp_DomainInfoReq (org.openrtk.idl.epp0604.epp_Command _m_cmd, String _m_name, org.openrtk.idl.epp0604.domain.epp_DomainHostsType _m_hosts_type)
  {
    m_cmd = _m_cmd;
    m_name = _m_name;
   ...
   */
  public epp_DomainInfoReq (org.openrtk.idl.epp0604.epp_Command _m_cmd, String _m_name, org.openrtk.idl.epp0604.domain.epp_DomainHostsType _m_hosts_type, org.openrtk.idl.epp0604.epp_AuthInfo _m_auth_info)
  {
    m_cmd = _m_cmd;
    m_name = _m_name;
    m_hosts_type = _m_hosts_type;
   ...
   * @see #m_hosts_type
   */
  public void setHostsType(org.openrtk.idl.epp0604.domain.epp_DomainHostsType value) { m_hosts_type = value; }
  /**
   * Accessor method for the hosts type of the domain object to be queried
   * @return The hosts type
   * @see #m_hosts_type
   */
  public org.openrtk.idl.epp0604.domain.epp_DomainHostsType getHostsType() { return m_hosts_type; }
