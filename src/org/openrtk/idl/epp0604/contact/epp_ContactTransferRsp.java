 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0604/contact/epp_ContactTransferRsp.java,v 1.2 2003/09/10 21:29:57 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
 * $Date: 2003/09/10 21:29:57 $<br>
 * @see com.tucows.oxrs.epp0604.rtk.xml.EPPContactTransfer
 * @see org.openrtk.idl.epp0604.contact.epp_ContactTransferReq
 */
public class epp_ContactTransferRsp implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setTrnData(org.openrtk.idl.epp0604.contact.epp_ContactTrnData)
   * @see #getTrnData()
   */
  public org.openrtk.idl.epp0604.contact.epp_ContactTrnData m_trn_data = null;
   ...
   */
  public epp_ContactTransferRsp (org.openrtk.idl.epp0604.epp_Response _m_rsp, String _m_id, org.openrtk.idl.epp0604.epp_TransferStatusType _m_transfer_status, String _m_request_client_id, String _m_request_date, String _m_action_client_id, String _m_action_date)
  {
    m_rsp = _m_rsp;
    m_trn_data = new org.openrtk.idl.epp0604.contact.epp_ContactTrnData();
   ...
   */
  public epp_ContactTransferRsp (org.openrtk.idl.epp0604.epp_Response _m_rsp, org.openrtk.idl.epp0604.contact.epp_ContactTrnData _m_trn_data)
  {
    m_rsp = _m_rsp;
   ...
   * @see #m_trn_data
   */
  public void setTrnData(org.openrtk.idl.epp0604.contact.epp_ContactTrnData value) { m_trn_data = value; }
  /**
   * Accessor method for the transfer data of the contact object in the registry
   * @return The contact's transfer data
   * @see #m_trn_data
   */
  public org.openrtk.idl.epp0604.contact.epp_ContactTrnData getTrnData() { return m_trn_data; }
   ...
   * @see #m_trn_data
   * @deprecated Please use setTrnData(org.openrtk.idl.epp0604.contact.epp_ContactTrnData) instead
   */
   ...
   * @deprecated Please use setTrnData(org.openrtk.idl.epp0604.contact.epp_ContactTrnData) instead
   */
  public void setTransferStatus(org.openrtk.idl.epp0604.epp_TransferStatusType value) { if ( m_trn_data == null ) { m_trn_data = new epp_ContactTrnData(); } m_trn_data.m_transfer_status = value; }
  /**
   * Accessor method for the transfer status associated with the contact object
