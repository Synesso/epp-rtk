 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0604/contact/epp_ContactCreateRsp.java,v 1.2 2003/09/10 21:29:57 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
...
public class epp_ContactCreateRsp implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_ContactCreateRsp (org.openrtk.idl.epp0604.epp_Response _m_rsp, String _m_id, String _m_creation_date)
  {
    m_rsp = _m_rsp;
    m_id = _m_id;
