 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0705/epp_Response.java,v 1.1 2003/03/20 22:42:19 tubadanm Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2003/03/20 22:42:19 $<br>
 * @see org.openrtk.idl.epp0705.epp_LoginRsp#setRsp(epp_Response)
 * @see org.openrtk.idl.epp0705.domain.epp_DomainCreateRsp#setRsp(epp_Response)
 */
public class epp_Response implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setResults(org.openrtk.idl.epp0705.epp_Result[])
   * @see #getResults()
   */
  public org.openrtk.idl.epp0705.epp_Result m_results[] = null;
  /**
   * The element that indicates stauts of the messages queued in the EPP server for client retrieval.
   * @see #setMessageQueue(org.openrtk.idl.epp0705.epp_MessageQueue)
   * @see #getMessageQueue()
   */
  public org.openrtk.idl.epp0705.epp_MessageQueue m_message_queue = null;
   ...
   * @see #setTransId(org.openrtk.idl.epp0705.epp_TransID)
   * @see #getTransId()
   */
   ...
   * @deprecated
   */
  public epp_Response (org.openrtk.idl.epp0705.epp_Result[] _m_results, org.openrtk.idl.epp0705.epp_MessageQueue _m_message_queue, String _m_extension_string, org.openrtk.idl.epp0705.epp_TransID _m_trans_id)
  {
   ...
   * @param _m_trans_id The transaction identifiers assigned by the client and the server
   */
  public epp_Response (org.openrtk.idl.epp0705.epp_Result[] _m_results, org.openrtk.idl.epp0705.epp_MessageQueue _m_message_queue, String[] _m_extension_strings, org.openrtk.idl.epp0705.epp_TransID _m_trans_id)
  {
    m_results = _m_results;
    m_message_queue = _m_message_queue;
   ...
   * @see #m_results
   */
  public void setResults(org.openrtk.idl.epp0705.epp_Result[] value) { m_results = value; }
  /**
   * Accessor method for the array of the results that document the success or failure of an EPP command execution
   * @return The array of the results
   * @see #m_results
   */
  public org.openrtk.idl.epp0705.epp_Result[] getResults() { return m_results; }
   ...
   * @see #m_message_queue
   */
  public void setMessageQueue(org.openrtk.idl.epp0705.epp_MessageQueue value) { m_message_queue = value; }
  /**
   * Accessor method for the element that indicates the status of the messages queued in the EPP server
   * @return The messages queue element
   * @see #m_message_queue
   */
  public org.openrtk.idl.epp0705.epp_MessageQueue getMessageQueue() { return m_message_queue; }
