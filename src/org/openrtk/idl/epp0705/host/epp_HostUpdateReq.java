 ...
 * in the registry.</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0705/host/epp_HostUpdateReq.java,v 1.2 2003/09/10 21:29:59 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
 * $Date: 2003/09/10 21:29:59 $<br>
 * @see com.tucows.oxrs.epp0705.rtk.xml.EPPHostUpdate
...
public class epp_HostUpdateReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setAdd(org.openrtk.idl.epp0705.host.epp_HostUpdateAddRemove)
   * @see #getAdd()
   */
  public org.openrtk.idl.epp0705.host.epp_HostUpdateAddRemove m_add = null;
  /**
   * The remove element that contains attribute values to be removed from the host object.
   * @see #setRemove(org.openrtk.idl.epp0705.host.epp_HostUpdateAddRemove)
   * @see #getRemove()
   */
  public org.openrtk.idl.epp0705.host.epp_HostUpdateAddRemove m_remove = null;
  /**
   * The change element that contains attribute values to be changed in the host object.
   * @see #setChange(org.openrtk.idl.epp0705.host.epp_HostUpdateChange)
   * @see #getChange()
   */
  public org.openrtk.idl.epp0705.host.epp_HostUpdateChange m_change = null;
   ...
   */
  public epp_HostUpdateReq (org.openrtk.idl.epp0705.epp_Command _m_cmd, String _m_name, org.openrtk.idl.epp0705.host.epp_HostUpdateAddRemove _m_add, org.openrtk.idl.epp0705.host.epp_HostUpdateAddRemove _m_remove, org.openrtk.idl.epp0705.host.epp_HostUpdateChange _m_change)
  {
    m_cmd = _m_cmd;
    m_name = _m_name;
    m_add = _m_add;
   ...
   * @see #m_add
   */
  public void setAdd(org.openrtk.idl.epp0705.host.epp_HostUpdateAddRemove value) { m_add = value; }
  /**
   * Accessor method for the add element that contains attribute values to be added to the host object
   * @return The add element
   * @see #m_add
   */
  public org.openrtk.idl.epp0705.host.epp_HostUpdateAddRemove getAdd() { return m_add; }
   ...
   * @see #m_remove
   */
  public void setRemove(org.openrtk.idl.epp0705.host.epp_HostUpdateAddRemove value) { m_remove = value; }
  /**
   * Accessor method for the remove to be associated with the host object
   * @return The remove element
   * @see #m_remove
   */
  public org.openrtk.idl.epp0705.host.epp_HostUpdateAddRemove getRemove() { return m_remove; }
   ...
   * @see #m_change
   */
  public void setChange(org.openrtk.idl.epp0705.host.epp_HostUpdateChange value) { m_change = value; }
  /**
   * Accessor method for the change element that contains attribute values to be changed
   * @return The change element
   * @see #m_change
   */
  public org.openrtk.idl.epp0705.host.epp_HostUpdateChange getChange() { return m_change; }
