...
public class epp_DomainPeriod implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #m_unit
   */
  public void setUnit(org.openrtk.idl.epp0705.domain.epp_DomainPeriodUnitType value) { m_unit = value; }
  /**
   * Accessor method for the unit type of the domain registration period
   * @return The unit type of period
   * @see #m_unit
   */
  public org.openrtk.idl.epp0705.domain.epp_DomainPeriodUnitType getUnit() { return m_unit; }
