 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0402/domain/epp_DomainTransferReq.java,v 1.2 2003/09/10 21:29:55 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
...
public class epp_DomainTransferReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_DomainTransferReq (org.openrtk.idl.epp0402.epp_Command _m_cmd, org.openrtk.idl.epp0402.epp_TransferRequest _m_trans, String _m_name, org.openrtk.idl.epp0402.domain.epp_DomainPeriod _m_period)
  {
    m_cmd = _m_cmd;
    m_trans = _m_trans;
    m_name = _m_name;
