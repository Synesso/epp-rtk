 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0402/domain/epp_DomainRenewRsp.java,v 1.2 2003/09/10 21:29:55 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
...
public class epp_DomainRenewRsp implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_DomainRenewRsp (org.openrtk.idl.epp0402.epp_Response _m_rsp, String _m_name, String _m_expiration_date)
  {
    m_rsp = _m_rsp;
    m_name = _m_name;
