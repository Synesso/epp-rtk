 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0402/domain/epp_DomainCheckReq.java,v 1.2 2003/09/10 21:29:55 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
...
public class epp_DomainCheckReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_DomainCheckReq (org.openrtk.idl.epp0402.epp_Command _m_cmd, String[] _m_names)
  {
    m_cmd = _m_cmd;
    m_names = _m_names;
  } // ctor
