 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0402/host/epp_HostCheckReq.java,v 1.2 2003/09/10 21:29:56 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
...
public class epp_HostCheckReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_HostCheckReq (org.openrtk.idl.epp0402.epp_Command _m_cmd, String[] _m_names)
  {
    m_cmd = _m_cmd;
    m_names = _m_names;
  } // ctor
