 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0402/contact/epp_ContactCreateRsp.java,v 1.2 2003/09/10 21:29:55 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
...
public class epp_ContactCreateRsp implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_ContactCreateRsp (org.openrtk.idl.epp0402.epp_Response _m_rsp, String _m_id)
  {
    m_rsp = _m_rsp;
    m_id = _m_id;
  } // ctor
   ...
   */
  public String toString() { return this.getClass().getName() + ": { m_rsp ["+m_rsp+"] m_id ["+m_id+"] }"; }
