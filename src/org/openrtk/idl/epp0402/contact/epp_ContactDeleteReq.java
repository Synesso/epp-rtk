 ...
 * in the registry.</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epp0402/contact/epp_ContactDeleteReq.java,v 1.2 2003/09/10 21:29:55 tubadanm Exp $<br>
 * $Revision: 1.2 $<br>
...
public class epp_ContactDeleteReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_ContactDeleteReq (org.openrtk.idl.epp0402.epp_Command _m_cmd, String _m_id)
  {
    m_cmd = _m_cmd;
    m_id = _m_id;
  } // ctor
